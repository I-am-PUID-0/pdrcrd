...
ENV \
  ...
  TERM=xterm 
RUN \
  apk add --update --no-cache tzdata ca-certificates wget fuse fuse3 python3 build-base py3-pip python3-dev py3-dotenv py3-schedule && ln -sf python3 /usr/bin/python && \
